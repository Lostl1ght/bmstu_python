...
class Car:
    ...
    def __init__(self, x, y, carcass, wheel1, wheel2):
        ...
        self.wheel1 = [pygame.image.load(wheel1).convert_alpha(),
                       pygame.image.load(wheel2).convert_alpha()]
        self.wheel1_rect = [self.wheel1[0].get_rect(center=(40, 75)),
                            self.wheel1[1].get_rect(center=(40, 75))]

        self.wheel2 = [pygame.image.load(wheel1).convert_alpha(),
                       pygame.image.load(wheel2).convert_alpha()]
...
car = Car(0, 90, 'moving_car\car.png',
          'moving_car\wheel1.png', 'moving_car\wheel2.png')
